...
| NFR-13 | Dostupnost | U slučaju kvara jedne komponente, druge funkcije sistema moraju ostati dostupne 99% vremena | Simulacija kvara  | Visok | Kvar jedne komponente ne bi trebao uticati na rad osnovnih funkcionalnosti |
...
| NFR-15 | Sigurnost | Sistem mora automatski odjaviti korisnika nakon perioda neaktivnosti od 15 minuta  | Testiranje sesija  | Srednji  | Spriječava zloupotrebu korisničkog računa  |
| NFR-16 | Integracija | Sistem mora omogućiti integraciju sa eksternim servisima (email servis)  | Testranje API integracija  | Srednji  | Servisi moraju biti pouzdani i podržavati stabilnu komunikaciju sa sistemom |
...
| NFR-23 | Sigurnost | Sistem treba ograničiti broj neuspješnih pokušaja prijave - maksimalno 3  | Testiranje pokušaja prijave | Srednji | Zaštita od napada |
...
| NFR-26 | Pouzdanost | Sistem treba automatski ponoviti neuspjele operacije (slanje emaila)  | Simulacija grešaka | Srednji | Retry logika za povećanje pouzdanosti sistema  |
