...
Predstavlja stavku rasporeda konferencije koja je vezana za jednu sesiju.
...
\### SessionRegistration i User

Atribut `isSpeaker` određuje da li je korisnik na datoj sesiji prijavljen kao predavač ili kao učesnik.
...
Jedna konferencija može imati više materijala.
...
Jedna sesija može imati više materijala.
...
Jedna konferencija može imati više stavki rasporeda, dok svaka stavka rasporeda pripada jednoj konferenciji.
...
Svaka agenda stavka odgovara tačno jednoj sesiji, a svaka sesija ima tačno jednu agenda stavku.
...
15\. Svaka agenda stavka mora biti povezana sa tačno jednom sesijom i koristi se za prikaz rasporeda konferencije.
